...
class usrp_packet_encoder_tx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, "hello_in.txt", True)
...
def main(top_block_cls=usrp_packet_encoder_tx, options=None):
